...
val packageAndRenameReleaseDistributionForCurrentOS by tasks.registering {
    group = "distribution"
    description = "Package and rename the release distribution for the current OS"
...
private fun renameReleaseDistributionForCurrentOS() {
    compose.desktop.application.nativeDistributions.targetFormats.map { targetFormat ->
        if (!targetFormat.isCompatibleWithCurrentOS) return@map
